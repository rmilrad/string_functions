...
Description:  function declarations for string class
******************************************************************************************************************************************************/
...
bool string_class::palindrome() {
	int l = 0, h = current_string.length();
	...
	while (l <= h) {
		...
		// of sentence 
		if (!(current_string[l] >= 'a' && current_string[l] <= 'z'))
			l++;

		// If there is another symbol in right  
		// of sentence 
		else if (!(current_string[h] >= 'a' && current_string[h] <= 'z'))
			h--;

		// If characters are equal 
		else if (current_string[l] == current_string[h])
			l++, h--;
